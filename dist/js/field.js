...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-TinyMCE', __webpack_require__(4));
  Vue.component('detail-TinyMCE', __webpack_require__(7));
  Vue.component('form-TinyMCE', __webpack_require__(10));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    ...
    editorConfigOptions: function editorConfigOptions() {
      ...
      var packageEditorConfig = Nova.config.novaTinyMCE.editorConfig;
    ...
    editorConfig: function editorConfig() {
      ...
      var height = this.height || config.height || 500;
